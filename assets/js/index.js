...
headerTl
// .to('.sc-header .group-logo .logo .logo-full .logo-top',2,{animationPlayState: "running", ease:'none'},'l')
// .to('.sc-header .group-logo .logo .logo-full .logo-bottom',2,{animationPlayState: "running", ease:'none'},'l')
...
.to('.sc-header .group-images .img',{
    visibility:'visible',
    onComplete:function(){
        // $('.sc-header .group-images .img').addClass('show');
    }
},'o-=.3')
...
gsap.set('.sc-introduce .group-introduce .sticky-introduce .bg .img2 img',{scale:1.2, opacity:0})
...
introTl
.to('.sc-introduce .group-introduce .sticky-introduce .bg .img1',4,{opacity:1},'a')
.to('.group-introduce .grid-shape .grid-rect:nth-child(1)',3,{scaleY:0, ease:'power1.inOut'},'a')
.to('.group-introduce .grid-shape .grid-rect:nth-child(2)',3,{scaleY:0, ease:'power1.inOut'},'a+=0.4')
.to('.group-introduce .grid-shape .grid-rect:nth-child(3)',3,{scaleY:0, ease:'power1.inOut'},'a+=0.8')
.to('.group-introduce .grid-shape .grid-rect:nth-child(5)',3,{scaleY:0, ease:'power1.inOut'},'a+=1.2')
.to('.group-introduce .grid-shape .grid-rect:nth-child(6)',3,{scaleY:0, ease:'power1.inOut'},'a+=1.6')
.to('.group-introduce .grid-shape .grid-rect:nth-child(8)',3,{scaleY:0, ease:'power1.inOut'},'a+=2')
.to('.group-introduce .grid-shape .grid-rect:nth-child(11)',3,{scaleY:0, ease:'power1.inOut'},'a+=2.4')

.to('.group-introduce .box1 .title span:first-child',1,{yPercent:0},'a+=4')
.to('.group-introduce .box1 .title span:nth-child(2)',1.5,{yPercent:0},'a+=4')


.to('.group-introduce .box1 .title span:first-child',1,{yPercent:-100},'b')
.to('.group-introduce .box1 .title span:nth-child(2)',1.5,{yPercent:-100},'b')
.to('.group-introduce .grid-shape .grid-rect:nth-child(4)',3,{scaleY:0, ease:'power1.inOut'},'b')
.to('.group-introduce .grid-shape .grid-rect:nth-child(9)',3,{scaleY:0, ease:'power1.inOut'},'b+=0.2')
.to('.group-introduce .grid-shape .grid-rect:nth-child(1)',3,{scaleY:1, ease:'power1.inOut'},'b+=0.4')
.to('.group-introduce .grid-shape .grid-rect:nth-child(8)',3,{scaleY:1, ease:'power1.inOut'},'b+=0.6')

.to('.group-introduce .box2 .text .line span',1,{
    yPercent:0,
    stagger:{
        each:0.3
    }
...
.to('.group-introduce .grid-shape .grid-rect:nth-child(2)',3,{scaleY:1, ease:'power1.inOut'},'c')
.to('.group-introduce .grid-shape .grid-rect:nth-child(8)',3,{scaleY:0, ease:'power1.inOut'},'c+=.2')
.to('.group-introduce .grid-shape .grid-rect:nth-child(9)',3,{scaleY:1, ease:'power1.inOut'},'c+=.4')
.to('.group-introduce .grid-shape .grid-rect:nth-child(10)',3,{scaleY:0, ease:'power1.inOut'},'c+=.6')
.to('.sc-introduce .group-introduce .sticky-introduce .bg .img1',4,{opacity:0},'c+=1.5')
.to('.sc-introduce .group-introduce .sticky-introduce .bg .video',4,{opacity:1},'c+=1.5')
.to('.group-introduce .box5 .text .line span',1,{yPercent:0,stagger:{
    each:0.1
}},'c+=2')


.to('.group-introduce .box5 .text .line span',1,{yPercent:-100, stagger:{
    each:0.1
}},'d')
.to('.group-introduce .grid-shape .grid-rect:nth-child(1)',3,{scaleY:0, ease:'power1.inOut'},'d')
.to('.group-introduce .grid-shape .grid-rect:nth-child(2)',3,{scaleY:0, ease:'power1.inOut'},'d+=.2')
.to('.group-introduce .grid-shape .grid-rect:nth-child(7)',3,{scaleY:0, ease:'power1.inOut'},'d+=.4')
.to('.group-introduce .grid-shape .grid-rect:nth-child(12)',3,{scaleY:0, ease:'power1.inOut'},'d+=.6')
.to('.group-introduce .grid-shape .grid-rect:nth-child(9)',3,{scaleY:0, ease:'power1.inOut'},'d+=.8')

.to('.sc-introduce .group-introduce .sticky-introduce .bg .video',3,{opacity:0},'d+=2.5')
.to('.sc-introduce .group-introduce .sticky-introduce .bg .img2 img',3,{scale:1, opacity:1},'d+=2.5')
.to('.sc-introduce .group-introduce .sticky-introduce .bg-invert',3,{opacity:1},'d+=3')
.to('.group-introduce .box6 .title span',1,{yPercent:0, stagger:{
    each:0.1
}},'d+=4')


.to('.group-introduce .box6 .title span',1,{yPercent:-100, stagger:{
    each:0.1
}},'e')
.to('.group-introduce .grid-shape .grid-rect',3,{scaleY:1, ease:'power1.inOut', stagger:{
    from:'end',each:0.2
}},'e')
.to('.group-introduce .title-blue .title span',2,{yPercent:0, stagger:{
    each:0.2
}},'e+=5')

.to('.group-introduce .title-blue .title span',2,{yPercent:-120, stagger:{
    each:0.2
}},'f')
.to('.sc-introduce .group-introduce .sticky-introduce .bg-white',4,{opacity:1},'f+=1')
.to('.group-introduce .title-beige .title span',2,{yPercent:0, stagger:{
    each:0.2
}},'f+=4')
...
.to('.sc-contents .group-contents img',{yPercent:15, ease:'power1.inOut'},'g')
.to('.sc-contents .group-contents .title2',{yPercent:-80, ease:'power1.inOut'},'g')
.to('.sc-contents .group-contents .title',{yPercent:-80, ease:'power1.inOut'},'g')
...
$('.sc-contents .group-letter').mousemove(function(e) {
    ...
    const maxSpan = 15;
    const spanElements = $('.sc-contents .group-letter .letter-area .letter-wrap span');
...
gsap.to('.sc-saltypebble .group-saltypebble .text-area',{
    scrollTrigger:{
...
.to('.sc-saltypebble .group-saltypebble .squares g:nth-child(2n)',10,{y:-101.3},'h')
.to('.sc-saltypebble .group-saltypebble .squares g:nth-child(2n+1)',10,{y:101.3},'h')
...
ScrollTrigger.create({
    ...
    start: "0% 80%",
    onEnter:function(){
        gsap.to('.sc-saltypebble .group-saltypebble .squares rect',1,{scaleY:1})
    },
    onLeaveBack:function(){
        gsap.to('.sc-saltypebble .group-saltypebble .squares rect',1,{scaleY:0})
    },
})
...
videoTl
.to('.sc-video .group-video .shapes rect',{scaleX:1,stagger:{
    each:.2
},ease:'power1.inOut'})
.set('.sc-video .group-video .shapes rect',{transformOrigin:"100% 0%"})
.to('.sc-video .group-video .shapes rect',{scaleX:0,stagger:{
    each:.2
},ease:'power1.inOut'},)


gsap.set('.sc-seasonedit .group-right .bg',{scaleY:0, transformOrigin: "100% 0%"})
gsap.set('.sc-seasonedit .group-right .video1 img',{scale:1.1, opacity:0})
gsap.set('.sc-seasonedit .group-left .left-area h2 .line span',{yPercent:120})


ScrollTrigger.create({
    trigger:'.sc-seasonedit',
    start: "0% 60%",
    onEnter:function(){
        gsap.to('.sc-seasonedit .group-right .bg',1.5,{
            scaleY:1,
            ease:"power1.inOut"
        },'g')
        gsap.to('.sc-seasonedit .group-right .video1 img',1.5,{
            scale:1,
            opacity:1,
            ease:"power1.inOut"
        },'g+=0.1')
        gsap.to('.sc-seasonedit .group-left .left-area h2 .line span',1.5,{
            yPercent:0,
            ease:"power1.inOut",
            stagger:{
                each:0.1
...
gsap.set('.sc-seasonedit .group-left .left-area .video2 video',{y:'-6vw'})

gsap.to('.sc-seasonedit .group-left .left-area .video2 video',{
    scrollTrigger:{
        trigger:'.sc-seasonedit',
        start:"0% 100%",
        end:"100% 0%",
...
gsap.set('.sc-hunter .group-hunter .video1 .overlay',{scaleX:1,transformOrigin:"100% 0%"})
...
ScrollTrigger.create({
    ...
    // markers:true,
    onEnter:function(){
        gsap.to('.sc-hunter .group-hunter .video1 .overlay',1.3,{scaleX:0, ease:'power1.inOut'})
...
collageTl
.to('.sc-collage .group-collage .img1 img',{yPercent:10,ease:'power1.inOut'},'i')
.to('.sc-collage .group-collage .img2 img',{yPercent:-20,ease:'power1.inOut'},'i')
.to('.sc-collage .group-collage .img3 img',{yPercent:-15,ease:'power1.inOut'},'i')
...
const lineElements = document.querySelectorAll('.sc-minumsa .group-text .text-area .line');
...
ScrollTrigger.create({
    ...
    onEnter:function(){
        ...
        openyyTl
        .to('.sc-openyy .shape-move rect',1,{scaleX:1,ease:'power1.inOut',stagger:{
            each:0.04
        }},'j')
