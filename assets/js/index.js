...
gsap.set('.sc-seasonedit .group-right .bg', {
  scaleY: 0,
  transformOrigin: '100% 0%',
});
gsap.set('.sc-seasonedit .group-right .video1 img', { scale: 1.1, opacity: 0 });
gsap.set('.sc-seasonedit .group-left .left-area h2 .line span', {
  yPercent: 120,
});
...
ScrollTrigger.create({
  ...
  onEnter: function () {
    ...
    gsap.to(
      '.sc-seasonedit .group-right .video1 img',
      1.5,
      {
        scale: 1,
        opacity: 1,
    ...
    gsap.to(
      '.sc-seasonedit .group-left .left-area h2 .line span',
      1.5,
      {
        yPercent: 0,
        ease: 'power1.inOut',
